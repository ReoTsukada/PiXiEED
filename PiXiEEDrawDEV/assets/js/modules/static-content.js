(() => {
  ...
  const HELP_GUIDE_ITEMS = Object.freeze([
    ...
    Object.freeze({
      ...
      keywords: { ja: '直線 曲線 四角 丸 塗りつぶし プレビュー', en: 'line curve rectangle ellipse fill preview', zh: '直线 曲线 矩形 椭圆 填充 预览' },
      points: {
        ja: [
  ...
  const BUILTIN_UPDATE_HISTORY_ENTRIES = Object.freeze([
    ...
    Object.freeze({
      ...
      details: Object.freeze([
        ...
        '出力完了ポップアップに「ホームへ戻る」「コンテストを見る」導線を追加。',
  ...
  const UI_LANGUAGE_ZH_MAP = Object.freeze({
    ...
    'サイズ': '尺寸',
    'サポーター特典': '支持者特典',
    'サポーター特典は500円です。広告非表示、共有プロジェクト4件、共同編集最大4人、マルチキャンバス追加3つまで利用できます。': '支持者特典为500日元：隐藏广告、解锁4个共享项目、最多4人协作编辑，并可追加最多3个多画布。',
    'サポーター特典を見る': '查看支持者特典',
    'サポーター特典を見る（外部サイト）': '查看支持者特典（外部网站）',
    'シートタブ': '工作表标签',
    ...
    '保存/出力の「保存完了後にコンテスト投稿画面へ移動する」をONにすると、そのまま投稿できます。': '开启保存/导出中的“保存完成后前往比赛投稿画面”即可直接投稿。',
    '保存出力形式': '保存/导出格式',
    '保存/出力形式': '保存/导出格式',
    '保存した作品を投稿して、みんなの作品もチェックできます': '可以投稿保存的作品，也可以查看大家的作品。',
    '保存した作品を投稿して、みんなの作品もチェックできます。': '可以投稿保存的作品，也可以查看大家的作品。',
    '倍率': '倍率',
    '倍率 (×)': '倍率 (×)',
    '停止': '停止',
