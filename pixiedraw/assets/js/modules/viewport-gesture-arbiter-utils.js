((root, factory) => {
  ...
  const VIEWPORT_GESTURE_CONFIG = Object.freeze({
    TOUCH_SLOP_PX: 6,
    PAN_CENTROID_SLOP_PX: 5,
    ZOOM_DISTANCE_SLOP_PX: 5,
    ZOOM_RATIO_SLOP: 0.015,
    MIN_PINCH_START_DISTANCE_PX: 24,
    PAN_DOMINANCE_RATIO: 1.25,
    ZOOM_DOMINANCE_RATIO: 1.25,
    GESTURE_DECISION_TIMEOUT_MS: 180,
