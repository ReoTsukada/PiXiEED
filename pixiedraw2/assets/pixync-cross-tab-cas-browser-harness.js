...
var PixyncDurableJournal = class _PixyncDurableJournal {
  ...
  static async open(projectId, persistence, options = {}) {
    ...
    const journal = new _PixyncDurableJournal(projectId, persistence, options, state);
    return journal;
  }
  snapshot() {
...
var PIXYNC_DRAW2_180_DB_PREFIX = "pixync-draw2-180-qualification-";
var PIXYNC_DRAW2_180_DB_NAME = `${PIXYNC_DRAW2_180_DB_PREFIX}v1`;
var PIXYNC_DRAW2_180_PROJECT_PREFIX = "pixync-draw2-180-";
var PIXYNC_DRAW2_180_API_KEY = "__pixyncDraw2CrossTabCas";
var journals = /* @__PURE__ */ new Map();
var nextJournalId = 0;
var nextOperationId = 0;
function requireProjectId(value) {
  if (typeof value !== "string" || !new RegExp(`^${PIXYNC_DRAW2_180_PROJECT_PREFIX}[A-Za-z0-9._:/-]{1,96}$`, "u").test(value)) {
    throw new TypeError(`PiXYNC Draw2 180 qualification projectId must use ${PIXYNC_DRAW2_180_PROJECT_PREFIX}.`);
  }
}
...
var loadState = globalThis.__pixyncDraw2CrossTabCasLoad;
if (loadState !== void 0) {
