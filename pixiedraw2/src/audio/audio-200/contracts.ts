...
/** Hardware-style chip machine profiles used by the Audio workspace. */
export type AudioChipMachineId = "NONE" | "GAME_BOY" | "FAMICOM";
export const AUDIO_CHIP_MACHINE_IDS: readonly AudioChipMachineId[] = [
  "NONE",
  "GAME_BOY",
  "FAMICOM",
] as const;
export function isAudioChipMachineId(
  value: unknown,
): value is AudioChipMachineId {
  return typeof value === "string" &&
    (AUDIO_CHIP_MACHINE_IDS as readonly string[]).includes(value);
}
...
export interface AudioProject {
  ...
  readonly chipMachineId?: AudioChipMachineId;
