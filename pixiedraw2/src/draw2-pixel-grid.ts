 ...
 * Fractional CSS pixels are intentional here: responsive mobile fit can make
 * one source pixel smaller than 1 CSS px, and rounding would accumulate a
 * visible phase drift across the checker pattern.
 */
