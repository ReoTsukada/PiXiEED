...
const sourceFiles = ["pixiedraw2/src/draw2-core.ts", "pixiedraw2/src/draw2-selection.ts", "pixiedraw2/src/draw2-entry.ts"];
...
console.log(JSON.stringify({
  schemaVersion: 1,
  benchmarkId: "WP120_DRAW2_SELECTION_TRANSFORM_BUNDLE",
  measuredAt: new Date().toISOString(),
  status: "MEASURED_LOCAL_BUILD",
  build: {
    command: "deno bundle --platform browser src/draw2-entry.ts -o dist/draw2-entry.js",
    minifiedCommand: "deno bundle --platform browser --minify src/draw2-entry.ts -o dist/draw2-entry.min.js",
  ...
  initialEditorEntry: {
    ...
    rawCompressed: compressions(raw),
    minifiedCompressed: compressions(minified),
  },
  ...
  lazyChunks: [],
  notes: [
    "The entry is the isolated Draw2 WP-120 slice; Audio, Game, Market, and production routes are not imported.",
