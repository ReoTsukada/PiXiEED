-- RETURNS TABLE room_id creates a PL/pgSQL output variable. A column-list
-- conflict target is therefore ambiguous; use the primary-key constraint name.
...
begin
  ...
  on conflict on constraint room_localization_members_pkey do nothing;
